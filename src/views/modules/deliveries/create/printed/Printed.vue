<template>
  <div class="ticket-list">
    <!-- menu superior -->
    <filter-swapper v-show="!loading.first" :trigger="selectedRows.length === 0" id="printed" :buttons="buttons" :controlHeightButtons="controlHeight">
      <template #slot1>
    ...
    <div v-show="!loading.first">
      <table-render id="table-printed" :schema="schema" :rows="rows" :actions="actions" showCheckboxes="true" :selectedRows.sync="selectedRows" :loading="loading.printed">
...
export default {
  ...
  watch: {
    ...
    'generalLoading': {
      handler () {
        this.loading.printed = !!this.generalLoading.getDeliveries
      },
      deep: true
    },
    'loading': {
